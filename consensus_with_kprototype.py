...
###############################################
# adjusted to k-prototype by Eran Shpigelman  #
#                                             #
# github.com/Eranshp/clustering_echo_covid.git#
#                                             #
###############################################
...
class ConsensusCluster:
    ...
    def fit(self, data, df_numeric, df_categorical, gamma=None, verbose=True):
        """
        ...
        for k in range(self.L_, self.K_):  # for each number of clusters
            ...
            for h in range(self.H_):  # resample H times
                ...
                Mh = KPrototypes(n_clusters=k, verbose=0, max_iter=100, n_init=50, gamma=gamma).fit(mark_array,
                                                                                            categorical=categorical_features_idx).labels_
